        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedinIcon = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HappyClientsIcon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProjectsDone = table.Column<int>(type: "int", nullable: false),
                    ProjectsDoneIcon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WinAwards = table.Column<int>(type: "int", nullable: false),
                    WinAwardsIcon = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AboutActions_About_AboutId",
                        column: x => x.AboutId,
